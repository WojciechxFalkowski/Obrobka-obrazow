 ...
 */
export const rgba_to_lab = (c, oldBC) => {
  c = normalize_rgb(c);
  let bc = typeof oldBC !== 'undefined' ? normalize_rgb(oldBC) : { R: 255, G: 255, B: 255 };
  let new_c = {
    R: bc.R + (c.R - bc.R) * c.A,
    G: bc.G + (c.G - bc.G) * c.A,
    B: bc.B + (c.B - bc.B) * c.A
